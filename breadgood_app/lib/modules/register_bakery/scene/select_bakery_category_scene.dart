...
class SelectBakeryCategoryScene extends StatefulWidget {
  const SelectBakeryCategoryScene({Key key}) : super(key: key);

  @override
  _SelectBakeryCategorySceneState createState() =>
      _SelectBakeryCategorySceneState();
}

class _SelectBakeryCategorySceneState extends State<SelectBakeryCategoryScene> {
                  ...
                  Align(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Get.to(RegisterReviewScene(), arguments: -1);
                      },
                    ),
                  ),
                ],
  ...
  _updateNextButtonDisabledState() {
    _isDisabledNextButton = controller.selectedBakeryCategories
                ...
                style: ElevatedButton.styleFrom(
                  shape: RoundedRectangleBorder(
                      ...
                      side: BorderSide(
                          width: 1.0,
                          color: controller
                              .bakeryCategoryBorderColor[category.id - 1])),
                  elevation: 0,

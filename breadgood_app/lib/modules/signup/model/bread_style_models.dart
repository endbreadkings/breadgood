...
List<BreadStyleModels> breadStyleFromJson(String str) => List<BreadStyleModels>.from(
...
class BreadStyleModels {
  ...
  BreadStyleModels(
      {this.content, this.id, this.imgUrl, this.name, this.profileImgUrl,this.check=false});

...
import 'package:breadgood_app/modules/register_review/repository/register_review_repository.dart';

class RegisterReviewScene extends StatefulWidget {
  const RegisterReviewScene({Key key}) : super(key: key);

  @override
  _RegisterReviewSceneState createState() => _RegisterReviewSceneState();
}

class _RegisterReviewSceneState extends State<RegisterReviewScene> {
  ...
  reviewImages() {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      RaisedButton(
        child: Text("사진 추가하기 ($curImageCount/$maxImageCount) >",
            style: TextStyle(
                fontSize: 16,
  ...
  _changeReviewButtonColor() {
    if (bakeryId == -1) {
      if ((textcnt > 9) &&
          (controller.selectedEmojiId != -1) &&
          (!isEmptyAllSignatureMenuTexts)) {
        return Color(0xFF4579FF);
      }
      return Color(0xFFC7C7C7);
    } else {
      if ((textcnt > 9) && (controller.selectedEmojiId != -1)) {
        return Color(0xFF4579FF);
      }
      return Color(0xFFC7C7C7);
    }
                  ...
                  if (bakeryId == -1) {
                    if ((textcnt > 9) &&
                      ...
                      bakeryToRegister.bakeryCategoryId =
                          controller.selectedBakeryCategoryId + 1;
                      ...
                      bakeryToRegister.emojiId = controller.selectedEmojiId;
                              ...
                              child: ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                  ...
                                  shape: RoundedRectangleBorder(
                                    ...
                                    side: BorderSide(
                                        color: controller.emojiBorderColor[
  ...
  Future<void> getImage() async {
    ...
    setState(() {
      curImageCount = resultList.length;

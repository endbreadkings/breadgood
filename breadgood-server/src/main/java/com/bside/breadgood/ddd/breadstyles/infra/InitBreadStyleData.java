...
public class InitBreadStyleData {
    ...
    private void add(String name, String content, String contentImgUrl, String profileImgUrl, String color, int sortNumber) {
        data.add(new BreadStyle(name, content, contentImgUrl, profileImgUrl, color, sortNumber));
    }
}
